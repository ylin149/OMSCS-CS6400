DROP DATABASE IF EXISTS CS6400_Summer2023_Team025;
...
CREATE TABLE Appliance(  
    ...
    appliance_type ENUM('Water heater','Air handler') NOT NULL,  
...
email varchar(320) NOT NULL, 
    	...
    	public_untility ENUM ('electric', 'gas', 'steam', 'liquid fuel') Not NULL, 

    	PRIMARY KEY(email, public_untility), 
